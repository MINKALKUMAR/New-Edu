...
export default function IndustryTestimonials() {
  const [isMuted, setIsMuted] = useState(true);
  const [isVisible, setIsVisible] = useState(false); // 👈 Lazy load trigger
  const iframeRef = useRef(null);
    ...
    <section className="industry-testimonials-dark">
      <div className="testimonials-content-dark">
        <div className="laptop-video-dark">
          ...
          {/* Video Placeholder / Lazy Loader */}
          <div className="video-frame-wrapper" ref={wrapperRef}>
            {!isVisible && (
              <div
                style={{
                  width: "100%",
